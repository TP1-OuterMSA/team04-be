...
public class NewMenuAdder {
    ...
    public void isNewMenus(List<Menu> menus) {
        ...
        if (!newMenus.isEmpty()) {
            List<Menu> savedMenus = saveMenus(newMenus); // ID 보장된 Menu
            processRelatedMeals(savedMenus);
        }
    }
